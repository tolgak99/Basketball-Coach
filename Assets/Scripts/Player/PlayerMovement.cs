...
public class PlayerMovement : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (_dragStarted)
        {
            ...
            {
                _touchDown = _touch.position;
                Debug.Log("Anim: " + PlayerAnimationController.Instance.isHolding);
                if (!PlayerAnimationController.Instance.isHolding)
                {
                    PlayerAnimationController.Instance.StartRunAnimation();
                }
            }
            ...
            if (_touch.phase == TouchPhase.Ended)
            {
                ...
                _isMoving = false;
                _dragStarted = false;
                PlayerAnimationController.Instance.EndRunAnimation();
            }
